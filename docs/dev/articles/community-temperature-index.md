...
This documents outlines how a multi-taxon indicator (Community
temperature index for Finnish Birds in Winter) can be calculated in R.
...
These filters restrict the survey data to the Dec-Jan “Winter Bird
Census” monitoring dataset from December 1958 onwards where the selected
...
A single processing function is applied to the survey data to limit each
...
A community temperature index for each year is created by fitting a
...
![Community Temperature Index for Winter Birds in
Finland](figure/plot-cti-1.png)
